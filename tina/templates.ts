...
export function embedded_videoFields() {
  return [
    {
      type: "object",
      name: "watch",
  ...
  return [
    {
      ...
      templates: [
        ...
        {
          fields: embedded_videoFields(),
          label: "Embedded Video",
          name: "embedded_video",
          nameOverride: "embedded-video",
        },
      ],
    },
    {
...
export function video_galleryFields() {
  return [
    ...
    {
      type: "boolean",
      name: "remove_title_and_filters",
      label: "Remove Title and Filters",
    },
  ] as TinaField[];
}
